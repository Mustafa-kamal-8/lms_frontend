...
import { ChevronDown, ChevronUp } from "lucide-react";
 import logo from "../../assets/educational-logo-learning-logo-book-with-pencil-in-negative-space-TWMGR3.jpg";
import "../../custom.css";
    ...
    >
      <div className="flex items-center justify flex-shrink-0 bg-white border-b border-gray-950 ">
        <img
          ...
          style={{ height: "4rem", width: "4.6rem", objectFit: "cover" }}
          src={logo}
          alt=""
        />
      </div>
      ...
      >
        {NavItems.map((item, index) => (
          <div key={index} className={`relative ${isCollapsed ? "group" : ""}`}>
            <div
              ref={(el) => {
                menuRefs.current[index] = el; // Assign without returning
              }}
      ...
      <div className="flex justify-end p-2">
        <button
          className="p-1 bg-theme-primary-active rounded-full hover:bg-theme-primary-active"
